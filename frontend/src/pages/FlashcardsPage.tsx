...
export function FlashcardsPage() {
  ...
  const flashcardsToReview = dueFlashcards.map(
    (progress) => progress.flashcard
  );
            ...
            <Card>
              <CardContent className="p-8 text-center space-y-4">
                ...
                <h3 className="text-lg font-semibold">
                  ¡Al día con tus revisiones!
                </h3>
                <p className="text-muted-foreground">
                  No hay flashcards pendientes de revisar en este momento.
                </p>
                <p className="text-sm text-muted-foreground">
                  Vuelve más tarde cuando tus flashcards estén listas para una
                  nueva revisión.
                </p>
